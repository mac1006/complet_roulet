...
while True:
    ...
    for n in range(0, len(name)):
        ...
        satz.append(input(name[n] + ", wie viel möchtest du setzen?\nDu hast " + str(guthaben[n]) + " Coins zur Verfügung\n"))
    ...
    schwarzezahlen = ['2', '4', '6', '8', '10', '11', '13', '15', '17', '20', '22', '24', '26', '28', '29', '31', '33', '35']
    ...
    for n in range(0, len(name)):
        if farbe[n] in rotezahlen and r in rotezahlen:
            print(name[n] + " hat " + str(int(satz[n]) * 35) + " Coins gewonnen\n")
            guthaben[n] = guthaben[n] + (int(satz[n])*35)

        elif farbe[n] in schwarzezahlen and r in schwarzezahlen:
            print(name[n] + " hat " + str(int(satz[n]) * 35) + " Coins gewonnen\n")
            guthaben[n] = guthaben[n] + (int(satz[n]) * 35)
